...
function(process_user_include_directories)
    ...
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/user_includes.txt")
        ...
        foreach(dir IN LISTS user_includes_list)
            ...
            target_include_directories(${CMAKE_PROJECT_NAME} PRIVATE "${full_path}")
        endforeach()
    else()
...
# Call the function to process include directories
process_user_include_directories()
