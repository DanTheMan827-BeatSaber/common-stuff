...
$outputContent = @"
/// @file $($ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($outputFile))
...
#ifndef MAKE_DEFERRED_HOOK_INSTALL_WITH_AUTOLOGGER
...
#ifndef MAKE_DEFERRED_ORIG_HOOK_INSTALL_WITH_AUTOLOGGER
...
#ifndef MAKE_DEFERRED_DIRECT_HOOK_INSTALL_WITH_AUTOLOGGER
...
#ifndef MAKE_DEFERRED_HOOK_INSTALL
...
#ifndef MAKE_DEFERRED_ORIG_HOOK_INSTALL
...
#ifndef MAKE_DEFERRED_DIRECT_HOOK_INSTALL
...
#ifndef INSTALL_DEFERRED_HOOKS
    /// @brief Macro to install all registered automatic hooks.
    #define INSTALL_DEFERRED_HOOKS() ::DeferredHooks::InstallHooks()
#endif
